...
class Model(object):
    def __init__(self, is_training, config):
        ...
        print("This is lstm_state size:",lstm_cell.state_size)
        print("This is lstm_output size:",lstm_cell.output_size)
        ...
        print("This is state size:",cell.state_size)
        print("This is output size:",cell.output_size)
        ...
        with tf.variable_scope("RNN"):
            for time_step in range(num_steps):
                ...
                #print("cell_output:",len(cell_output),cell_output)
